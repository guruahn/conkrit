...
?>
				...
				if (have_posts()) : while (have_posts()) : the_post();
					...
					if(has_post_thumbnail(get_the_ID(), 'blog3'))
					{
		        	...
		        	{	
		        		$last_class = ' last';
		        		$clear_both = '<br class="clear"/>';
		        	}
		        	$key++;
				?>	
						
					<!-- Begin each blog post -->
					<div class="post_wrapper one_third <?php echo $last_class; ?>">
						<?php
					    ...
					    <div class="post_header_wrapper">
					    	<div class="post_header half">
					    		<h5><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?>								
					    			</a>
					    		</h5>
