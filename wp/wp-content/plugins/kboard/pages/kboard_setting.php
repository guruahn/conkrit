						...
						<td>
							<select name="skin" id="skin" class="">
								...
								if(!$board->skin) {
                                    ...
                                    $selected_skin = $board->skin;
                                }
								foreach($skin->list AS $key => $value):
								?>
								<option value="<?php echo $value?>"<?php if($selected_skin == $value):?> selected<?php endif?>>
									<?php echo $value?>
								</option>
								<?php endforeach?>
							</select>
						...
						<td>
							<select name="page_rpp" id="page_rpp" class="">
                                ...
                                if(!$board->page_rpp) {
                                    ...
                                    $page_rpp=$board->page_rpp;
                                }
                                ?>
								<option value="2"<?php if($page_rpp == 2):?> selected<?php endif?>>2개</option>
								<option value="3"<?php if($page_rpp == 3):?> selected<?php endif?>>3개</option>
								<option value="4"<?php if($page_rpp == 4):?> selected<?php endif?>>4개</option>
								<option value="5"<?php if($page_rpp == 5):?> selected<?php endif?>>5개</option>
								<option value="6"<?php if($page_rpp == 6):?> selected<?php endif?>>6개</option>
								<option value="7"<?php if($page_rpp == 7):?> selected<?php endif?>>7개</option>
								<option value="8"<?php if($page_rpp == 8):?> selected<?php endif?>>8개</option>
								<option value="9"<?php if($page_rpp == 9):?> selected<?php endif?>>9개</option>
								<option value="10"<?php if($page_rpp == 10):?> selected<?php endif?>>10개</option>
								<option value="12"<?php if($page_rpp == 12):?> selected<?php endif?>>12개</option>
								<option value="15"<?php if($page_rpp == 15):?> selected<?php endif?>>15개</option>
								<option value="17"<?php if($page_rpp == 17):?> selected<?php endif?>>17개</option>
								<option value="20"<?php if($page_rpp == 20):?> selected<?php endif?>>20개</option>
								<option value="25"<?php if($page_rpp == 25):?> selected<?php endif?>>25개</option>
								<option value="30"<?php if($page_rpp == 30):?> selected<?php endif?>>30개</option>
								<option value="50"<?php if($page_rpp == 50):?> selected<?php endif?>>50개</option>
								<option value="100"<?php if($page_rpp == 100):?> selected<?php endif?>>100개</option>
							</select>
					...
					<tr valign="top">
						...
						<td>
							<select name="comment_skin" id="comment_skin" class="">
								<?php
								if(!$meta->comment_skin) {
                                    $selected_comment_skin = 'default';
                                }else{
                                    $selected_comment_skin = $meta->comment_skin;
                                }
								foreach($comment_skin->list AS $key => $value):
								?>
								<option value="<?php echo $value?>"<?php if($selected_comment_skin == $value):?> selected<?php endif?>><?php echo $value?></option>
								<?php endforeach?>
							</select>
