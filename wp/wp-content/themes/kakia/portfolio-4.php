...
<?php
    ...
    {
		$wp_query->query('showposts='.$pp_portfolio_items.'&post_type=portfolios&portfoliosets='.$term.'&orderby=menu_order&order=ASC'.'&paged='.$paged);
	}
...
<div class="portfolio-content section content clearfix"> 
    <?php
    	while ($wp_query->have_posts()) : $wp_query->the_post(); 
        	...
        	if(has_post_thumbnail($portfolio_ID, 'portfolio4'))
        	{
    ...
    ?>
        		<div class="<?php echo $portfolio_item_class.' '.$last_class.' '.$clear_class; ?>">
    				...
    				?>
    				    ...
    				    <div class="portfolio_desc portfolio_desc_200">
