...
?>
				...
				if (have_posts()) : while (have_posts()) : the_post();
					...
					if(has_post_thumbnail(get_the_ID(), 'blog2'))
					{
				...
				?>	
					...
					<div class="post_wrapper one_half <?php echo $last_class; ?>">
						<?php
					        if(isset($image_thumb[0]))
					        {
					    ?>	
					    <a href="<?php the_permalink(); ?>">
					    	<div class="post_half_img_wrapper">
					    		<img src="<?php echo $image_thumb[0]; ?>" alt=""/>
					    		<div class="post_half_img_overlay">
