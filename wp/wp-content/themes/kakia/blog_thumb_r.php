<?php
/**
 * Template Name: Blog Thumbnail Right Sidebar
...
?>
				...
				if (have_posts()) : while (have_posts()) : the_post();
					...
					if(has_post_thumbnail(get_the_ID(), 'blog_t'))
					{
					    $image_id = get_post_thumbnail_id(get_the_ID());
					    $image_thumb = wp_get_attachment_image_src($image_id, 'blog_t', true);
					}
				?>	
					...
					<div class="post_wrapper">
					    ...
					    <a href="<?php the_permalink(); ?>">
					    	<div class="blog_thumb">
						    	<img src="<?php echo $image_thumb[0]; ?>" alt="" class="blog_thumbnail"/>
