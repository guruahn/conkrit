<?php
/**
 * Template Name: Portfolio Grid 3 Columns Filterable
...
?>
    	...
    	<div id="ajax_<?php echo $portfolio_item['ID']; ?>" class="ajax_portfolio_wrapper">
    		<h3 class="portfolio_single_title"><?php echo $portfolio_item['title']; ?></h3>
...
<div id="portfolio_filter_wrapper" class="three_columns portfolio-content section content clearfix"> 
    ...
    ?>
			<div class="element <?php echo $portfolio_item_set; ?> portfolio_grid3">
